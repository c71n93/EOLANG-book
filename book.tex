...
\textit{a} for the initial value of the accumulator.
\textit{f} for the object that represents the reduction function. It must have two free attributes:
The first attribute is the current value of the accumulator.
The second attribute is the current object of the array.
The \textit{f} attribute object aggregates the objects of the array in the accumulator. Objects of the array arrive into the \textit{f} in the order these objects are stored in the array.
